...
if _has_sklearn:
    ...
    def acc_f1_mcc_auc_aupr_pre_rec_5cls(preds, labels, probs):
    # 计算准确率
    ...
    def pearson_and_spearman(preds, labels):
        ...
        rmse_score = np.sqrt(mean_squared_error(labels, preds))
        return {
    ...
    def glue_compute_metrics(task_name, preds, labels, probs=None):
        ...
        if task_name == "cola":
            ...
            return {"acc": simple_accuracy(preds, labels)}
        elif task_name == "genepred":
            return pearson_and_spearman(preds, labels)
        elif task_name == "cre5clas":
            return acc_f1_mcc_auc_aupr_pre_rec_5cls(preds, labels, probs)
        elif task_name == "cre4clas":
            return acc_f1_mcc_auc_aupr_pre_rec_5cls(preds, labels, probs)
        else:
