...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    Examples::
        ...
        if labels is not None:
            ...
            # 获取预测的标签
            predict_labels = torch.argmax(shift_logits, dim=-1)  # 在最后一个维度选择最大值的索引
            # print("Predicted Labels Shape:", predict_labels.shape)
            # print("Predicted Labels:", predict_labels[:,:-10])
            
            # 获取真实标签
            # print("True Labels Shape:", shift_labels.shape)
            # print("True Labels:", shift_labels)
