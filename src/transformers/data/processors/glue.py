...
class Cre5ClsProcessor(DataProcessor):
    """Processor for the DNA promoter data"""
...
class Cre4ClsProcessor(DataProcessor):
    """Processor for the DNA promoter data"""
...
class GenePredProcessor(DataProcessor):
    """Processor for the gene expression data"""
    def get_labels(self):
        return ["0", "1"] 
...
glue_processors = {
    ...
    "genepred": GenePredProcessor,
    "dnapair": DnaPairProcessor,
    "dnasplice": DnaSpliceProcessor,
    "cre5clas": Cre5ClsProcessor,
    "cre4clas": Cre4ClsProcessor
}
...
glue_output_modes = {
    ...
    "cre5clas": "classification",
    "cre4clas": "classification"
}
